    ...
    return (
      <div className="home-page">
            ...
            <div className="row">
              ...
              <div className="col-md-8">
                ...
                <p className="btn-collection">
                  <Link to="started" className="btn btn-primary">Get Started</Link>
        ...
        <div className="text-center">
          <p className="lead">Get-Set-Go is an open source project. It's hosted, developed, and maintained on GitHub.</p>
